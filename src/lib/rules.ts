...
export const defaultAppConfig: AppConfig = {
  name: "我的主页✨",
  favicon: "/star-48-round.ico",
  keywords: "remio,rem,mio,C.C.,Nahida-aa,个人主页,主页",
  description: "Nahida-aaの次元，兴趣至上，内容随缘，个人主页",
  avatarConfig: {
    src: "./avatar/star-360-d.webp",
    size: 150,
    round: "full",
    hoverAnimate: "top",
    style: "glint",
  ...
  links: [
    ...
    },
    {
      title: "github",
      color: "#000000",
      url: "https://github.com/Nahida-aa",
      icon: "github",
    },
    {
      title: "email",
