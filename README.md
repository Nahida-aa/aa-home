...
# 如果你是用的阿里云镜像，则运行下面这个
docker run --name remio-home -p 3004:3000 --env-file .env -v src/config:/remio-home/config -v public/icons:/remio-home/public/icons -v public/fonts:/remio-home/public/fonts -d registry.cn-shanghai.aliyuncs.com/remio/remio-home
```
...
```sh
# 启动 docker-compose 中的 remio-home 服务
...
[![Deploy with Vercel](https://vercel.com/button)](https://vercel.com/new/clone?repository-url=/remio-home&env=PASSWORD&project-name=remio-home&repository-name=remio-home)
